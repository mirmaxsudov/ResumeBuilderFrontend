                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 mb-2">support@resumebuilder.com</p>
                      <p className="text-gray-600 mb-2">sales@resumebuilder.com</p>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 mb-2">Saturday: 10:00 AM - 4:00 PM PST</p>
