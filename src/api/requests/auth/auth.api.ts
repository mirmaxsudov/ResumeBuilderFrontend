...
const changePasswordForAuth = async (oldPassword: string, newPassword: string): Promise<ApiResponse<string>> => {
    const response = await $api.patch(BASE_AUTH_URL + "/change-password-for-auth", null, {
        params: {
