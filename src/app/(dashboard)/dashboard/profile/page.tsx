import {Edit, MapPin, Briefcase, GraduationCap, Award, Calendar, Mail, Phone, Globe, Download} from "lucide-react"
            ...
            <div className="bg-white rounded-xl shadow-sm mb-6 overflow-hidden">
                ...
                <div className="px-6 pb-6 relative">
                    <div className="flex flex-col md:flex-row items-start md:items-end">
                        <div
                            className="absolute -top-16 left-6 w-32 h-32 rounded-xl overflow-hidden border-4 border-white shadow-md bg-white">
                            <Image
                        ...
                        <div className="mt-20 md:mt-0 md:ml-36 flex-1">
                            <div className="flex flex-col md:flex-row md:items-center justify-between">
                                <div>
                                    <h1 className="text-2xl font-bold text-gray-900">Akbarxoja Joraxojayev</h1>
                                    <p className="text-gray-600">Software Engineer</p>
                                </div>
                                <div className="mt-4 md:mt-0 flex space-x-3">
                                    <Button variant="outline" className="rounded-full hover:bg-blue-50 btn-hover">
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white rounded-xl shadow-sm p-6">
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            <span className="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-sm">Git</span>
                            <span className="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-sm">REST APIs</span>
                            <span className="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-sm">SQL</span>
                        </div>
                    </div>
                ...
                <div className="md:col-span-2 space-y-6">
                    ...
                    <div className="bg-white rounded-xl shadow-sm p-6">
                        ...
                        <p className="text-gray-700">
                            Experienced Software Engineer with a passion for building scalable web applications. Skilled
                            in
                            JavaScript, React, and Node.js. Strong problem-solving abilities and a team player with
                            excellent
                            communication skills. Looking for opportunities to contribute to innovative projects and
                            continue growing
                            as a developer.
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm p-6">
                        ...
                        <div className="space-y-6">
                            <div className="border-l-2 border-blue-500 pl-4 ml-2">
                                ...
                                <p className="text-gray-700">
                                    Led the development of a React-based dashboard application. Implemented new features
                                    and optimized
                                    performance. Mentored junior developers and conducted code reviews.
                                </p>
                            </div>
                            <div className="border-l-2 border-gray-300 pl-4 ml-2">
                                ...
                                <p className="text-gray-700">
                                    ...
                                    designers and
                                    product managers to implement new features. Improved application performance by 30%.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm p-6">
                        ...
                        <div className="space-y-6">
                            <div className="border-l-2 border-blue-500 pl-4 ml-2">
                                ...
                                <p className="text-gray-700">
                                    Specialized in Software Engineering and Artificial Intelligence. Graduated with
                                    honors.
                                </p>
                            </div>
                            <div className="border-l-2 border-gray-300 pl-4 ml-2">
                                <div className="flex items-center mb-1">
                                    ...
                                    <h3 className="font-medium text-gray-900">Bachelor of Science in Computer
                                        Science</h3>
                                </div>
                                <p className="text-gray-700 mb-1">University of California, Berkeley</p>
                                <div className="flex items-center text-gray-500 text-sm mb-2">
                                    <Calendar size={14} className="mr-1"/>
                                    <span>2012 - 2016</span>
                                </div>
                                <p className="text-gray-700">Dean's List, GPA 3.8/4.0. Active member of the Computer
                                    Science Club.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-500 text-sm">Amazon Web Services • 2022</p>
                                </div>
                            </div>
                            <div className="flex items-start">
                                <Award className="w-5 h-5 text-blue-600 mt-0.5 mr-3"/>
                                <div>
                                    <h3 className="font-medium text-gray-900">Google Cloud Professional Developer</h3>
                            ...
                            <div className="flex items-start">
                                <Award className="w-5 h-5 text-blue-600 mt-0.5 mr-3"/>
                                <div>
                                    <h3 className="font-medium text-gray-900">React Advanced Certification</h3>
