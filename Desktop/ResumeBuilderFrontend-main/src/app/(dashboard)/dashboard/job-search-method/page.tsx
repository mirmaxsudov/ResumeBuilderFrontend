    ...
    return (
        <>
            ...
            <div className="bg-gray-50 border rounded-lg p-8 text-center">
                ...
                <p className="text-gray-500 mb-4">Learn effective methods to find and apply for jobs</p>
                <Button className="bg-blue-500 hover:bg-blue-600">Explore Methods</Button>
            </div>
        </>
    )
}