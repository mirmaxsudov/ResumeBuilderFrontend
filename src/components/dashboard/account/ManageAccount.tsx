            ...
            <div className="bg-[#fff] p-[20px] rounded-[10px] flex justify-between flex-col items-center gap-[2 0px] shadow-md mt-[10px]"    >
                <div className="grid grid-cols-2 gap-[20px] w-full">
                    <Label className="text-gray-500 text-sm font-normal w-full">
                        First Name
                        <Input onChange={e => setReq({ ...req, firstname: e.target.value })} type="text" className="mt-[5px] w-full text-[#000]" defaultValue={user.firstName} placeholder="Enter your first name" />
                    </Label>
                    <Label className="text-gray-500 text-sm font-normal w-full">
                        Last Name
                        <Input onChange={e => setReq({ ...req, lastname: e.target.value })} type="text" className="mt-[5px] w-full text-[#000]" defaultValue={user.lastname} placeholder="Enter your last name" />
                    </Label>
                </div>
                <div className="w-full grid grid-cols-2 gap-[20px] items-center my-[20px]">
                    <Label className="text-gray-500 text-sm font-normal w-full">
                        Email
                        <Input disabled onChange={e => setReq({ ...req, email: e.target.value })} type="email" className="mt-[5px] w-full text-[#000]" defaultValue={user.email} placeholder="Enter your email" />
                    </Label>
                    <div>
