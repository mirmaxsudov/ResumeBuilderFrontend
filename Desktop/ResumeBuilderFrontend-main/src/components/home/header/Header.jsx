                    ...
                    <div className="grid grid-cols-2 gap-[100px] items-center">
                        <div className="left">
                            <h5 className='text-[14px] font-normal mb-[10px]'>
                                <span
                                    className='bg-green-500 w-[10px] h-[10px] rounded-full inline-block me-2 animate-ping'></span> 42,501
                        ...
                        <div className="right">
                            <Image src={HeaderImage} alt={"Image"} className={"w-full drop-shadow-lg"}/>
                        </div>
                    </div>
                </div>
            </div>
